			...
			<div class="container">
					...
					<div class="footer-grid">
						...
						<div class="footer-col footer-about">
							<div class="footer-logo">
								...
								<span class="site-title">نسق</span>
							</div>
							...
							<div class="social-links">
								<?php
								$facebook = get_theme_mod( 'nasaq_facebook', '#' );
								$twitter = get_theme_mod( 'nasaq_twitter', '#' );
								$instagram = get_theme_mod( 'nasaq_instagram', '#' );
								$linkedin = get_theme_mod( 'nasaq_linkedin', '#' );
								?>
								<?php if ( $facebook ) : ?>
						...
						<div class="footer-col">
							...
							<ul class="footer-contact">
								<li>
									...
									<a href="mailto:<?php echo esc_attr( get_theme_mod( 'nasaq_email', 'info@nasaq.sa' ) ); ?>">
										<?php echo esc_html( get_theme_mod( 'nasaq_email', 'info@nasaq.sa' ) ); ?>
									</a>
								</li>
								<li>
									<span class="contact-icon">📞</span>
									<a href="tel:<?php echo esc_attr( str_replace( ' ', '', get_theme_mod( 'nasaq_phone', '+966500000000' ) ) ); ?>">
										<?php echo esc_html( get_theme_mod( 'nasaq_phone', '+966 50 000 0000' ) ); ?>
									</a>
								</li>
								<li>
									<span class="contact-icon">📍</span>
									<span><?php echo esc_html( get_theme_mod( 'nasaq_address', 'الرياض، المملكة العربية السعودية' ) ); ?></span>
								</li>
							</ul>
						</div>
					</div>
				...
				<div class="footer-bottom">
					<div class="footer-copyright">
						<p>&copy; <?php echo date( 'Y' ); ?> نسق للحلول البرمجية. جميع الحقوق محفوظة. صُنع بـ ❤️</p>
					</div>
